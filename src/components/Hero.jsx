    ...
    return(
        <section className="min-h-screen flex justify-center items-center px-6 text-center">
          <div className="max-w-3xl">
            ...
            <p className="text-sm text-gray-500 mb-8">Built and deployed a production system used by a real-business to manage leads, content, and customer interactions.</p>
